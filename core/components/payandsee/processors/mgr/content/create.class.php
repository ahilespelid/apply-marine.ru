...
/**
 * Create an PasContent
 */
class PasContentCreateProcessor extends modObjectCreateProcessor
{
    ...
    public function beforeSet()
    {
        ...
        if ($this->doesAlreadyExist(array('resource' => $this->getProperty('resource')))) {
...
return 'PasContentCreateProcessor';