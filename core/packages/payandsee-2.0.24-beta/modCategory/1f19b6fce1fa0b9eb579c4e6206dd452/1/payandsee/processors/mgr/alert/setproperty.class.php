...
/**
 * SetProperty a PasAlert
 */
class PasAlertSetPropertyProcessor extends PasAlertUpdateProcessor
{
    ...
    public static function getInstance(modX &$modx, $className, $properties = array())
    {
        ...
        $processor = new PasAlertSetPropertyProcessor($modx, $properties);
...
return 'PasAlertSetPropertyProcessor';