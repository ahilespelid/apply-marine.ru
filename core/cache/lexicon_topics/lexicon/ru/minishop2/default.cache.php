<?php  return array (
  ...
  'setting_ms2_product_thumbnail_default' => 'Путь к превью по умолчанию',
  'setting_ms2_product_thumbnail_default_desc' => 'Здесь вы можете указать путь к превью товара, по умолчанию указан логотип miniShop2. Если оставить поле пустым, то превью товара будет скрыто, до тех пор, пока в галерею не будут загружены изображения товара.',
  ...
  'setting_ms2_payment_paypal_cancel_order_desc' => 'Если включено, заказ будет отменён при отказе от оплаты',
