<?php  return array (
  ...
  'setting_office_frontend_js_desc' => 'Path to file with the main javascript of the office. If you want to use your own scripts - specify them here, or clean this parameter and load them in site template.',
  'setting_office_sanitize_pcre' => 'Data cleansing',
  'setting_office_sanitize_pcre_desc' => 'Regular expression that specifies what will be cut when saving profile data.',
  'setting_office_controllers_paths' => 'Controllers paths',
  'setting_office_controllers_paths_desc' => 'JSON encoded string with array where keys are names of controllers and values is path where to find them. For example: {"extra":"[[++core_path]]components/extra/controllers/office/"}. Office will try to load "extra/someaction" from this path in the first place.',
  ...
  'setting_office_auth_frontend_js_desc' => 'Path to file with the Auth javascript. If you want to use your own scripts - specify them here, or clean this parameter and load them in site template.',
  ...
  'setting_office_profile_frontend_js_desc' => 'Path to file with the Profile javascript. If you want to use your own scripts - specify them here, or clean this parameter and load them in site template.',
  ...
  'setting_office_ms2_frontend_js_desc' => 'Path to file with the miniShop2 javascript. If you want to use your own scripts - specify them here, or clean this parameter and load them in site template.',
  'setting_office_sms_provider' => 'SMS Provider',
  'setting_office_sms_provider_desc' => 'Providers available by default: SmsRu and ByteHand',
  'setting_office_sms_id' => 'Client login',
  'setting_office_sms_id_desc' => 'Unique login for authorization at the provider. For SmsRu it is "api_id", for ByteHand it is just "id".',
  'setting_office_sms_key' => 'Client key',
  'setting_office_sms_key_desc' => 'Key for authorization at the provider. By default required only for ByteHand.',
  'setting_office_sms_from' => 'Sender',
  'setting_office_sms_from_desc' => 'The name of SMS sender. Usually <strong>you need to confirm it</strong> at provider before use.',
  'setting_office_check_csrf' => 'Check CSRF token',
  'setting_office_check_csrf_desc' => 'Enable to protect against automatic registrations.',
  'setting_office_auth_mode' => 'Auth mode',
  'setting_office_auth_mode_desc' => 'You can set the mode of authentication: email or phone.',
  'setting_office_auth_activation' => 'User activation',
  'setting_office_auth_activation_desc' => 'Require user activation via a link in email or a code from SMS',
  ...
  'office_err_mgr_auth' => 'You are logged into the manager, but not in the current context. Please log out of the manager or login in the current context.',
  'office_auth_as_user' => 'Authorize',
  'office_err_csrf' => 'Error checking CSRF token, it may be outdated. Try to reload the page.',
);