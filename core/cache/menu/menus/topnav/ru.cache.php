<?php  return array (
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        'parent' => 'components',
        'action' => 'home',
        'description' => 'Управление robots.txt и sitemap.xml',
        'icon' => '',
        'menuindex' => 6,
        'params' => '',
        'handler' => '',
  ...
  array (
    ...
    'parent' => 'topnav',
    'action' => '',
    'description' => 'Приложения используемые для отладки системы управления и сайта',
    'icon' => '',
    'menuindex' => 4,
    'params' => '',
    'handler' => '',
