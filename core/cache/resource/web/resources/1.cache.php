<?php  return array (
  ...
  array (
    ...
    'pagetitle' => 'Комплексные услуги для морских компаний и моряков',
    'longtitle' => 'О нас',
    'description' => '',
    'alias' => 'index',
    'alias_visible' => 1,
    ...
    'isfolder' => 0,
    'introtext' => '',
    'content' => '<p>Наша молодая компания основана в 2021 году, имея амбициозные планы и эффективные методы достижения наилучших результатов в самые кратчайшие сроки.</p>
<p>Мы являемся партнерами крупнейших работодателей Европы, Азии, Ближнего Востока и Америки, активно сотрудничая с крупными компаниями Африканского сектора.</p>
<p>Наши специалисты помогут вам реализовать планы по подготовке и подбору персонала, предоставив сопровождение от подготовки документов до освоения языковых навыков в кратчайшие сроки.</p>
<p>Добро пожаловать в Apply Marine прямо сейчас!</p>',
    'richtext' => 1,
    'template' => 5,
    'menuindex' => 0,
    'searchable' => 1,
    ...
    'show_in_tree' => 1,
    'properties' => '{"ms2gallery":{"media_source":"4"},"autoredirector":{"old_uri":"index.html"}}',
    'meta-description' => 
    array (
      0 => 'meta-description',
      1 => 'Комплексные услуги для морских компаний и моряков от apply-marine.ru. ',
      2 => 'default',
      3 => NULL,
      4 => 'text',
    ),
    ...
    array (
      0 => 'tvAddContent',
      1 => '<p>Наша команда преследует непростые, но в тоже время интересные задачи, в которых наши специалисты профессионалы.</p>
<ul>
<li>Обеспечить каждого клиента работодателя лучшими специалистами в сфере, подготовленными и протестированными под требование заказчика;</li>
<li>Подготовка специалиста к трудоустройству, а так же ведение специалиста с момента отправки, до возвращения домой;</li>
<li>Наши специалисты снабжения обеспечат лучшие конкурентоспособные предложения в отрасли по региону;</li>
<li>Туристическая индустрия откроется по новому с учетом персональных пожеланий и возможностями подбора индивидуальной программы на каждой стадии вашего путешествия;</li>
<li>Наши менеджеры, экономисты, юристы и профессиональные инженеры, помогут вам достичь успеха в каждой вашей идее, будь то бизнес, производство или создание новых мощностей и сооружений;</li>
<li>Специалисты лингвистики помогут Вам преодолеть международные барьеры.</li>
<li>Визовый центр Apply Marine создан помочь Вам в подготовке и получении виз и соответствующих документов с минимальными потерями времени.</li>
<li>Новостной портал Apply Marine, будет держать вас в курсе последних известий морской и туристической отраслей.</li>
</ul>',
      2 => 'default',
      3 => NULL,
      4 => 'richtext',
    ...
    array (
      0 => 'meta-keywords',
      1 => 'услуги для морских компаний. услуги для моряков',
      2 => 'default',
      3 => NULL,
      4 => 'text',
    ),
    ...
    array (
      0 => 'meta-title',
      1 => 'Комплексные услуги для морских компаний и моряков',
      2 => 'default',
      3 => NULL,
      4 => 'text',
    ),
...
<head>
	...
	<title>Комплексные услуги для морских компаний и моряков | [[!++my_metaTail]]</title>
	<meta name="description" content="Комплексные услуги для морских компаний и моряков от apply-marine.ru. " />
	<meta name="keywords" content="услуги для морских компаний. услуги для моряков" />
	<meta name="viewport" content="width=device-width, initial-scale=1" />
	[[!++my_metategs]]
	<meta name="robots" content="all"/>
	<base href="[[!++site_url]]">
	
	<meta property="og:title" content="Комплексные услуги для морских компаний и моряков">
    <meta property="og:description" content="Комплексные услуги для морских компаний и моряков от apply-marine.ru. ">
    <meta property="og:type" content="website">
    <meta property="og:url" content="https://test.apply-marine.ru/index">
...
<!-- /Блок слайдера -->
	...
	<div class="fixed-mobile-block">
 	...
 	<div id="content-block">
		...
		<!-- Контент на титульной -->
		<div class="title-content padding-top padding-bottom">
			<div class="container">
				<div class="row">
					<div class="title-content__block title-content__img col-12 col-md-6 padding-bottom">
						<img src="/template/img/logotype-big.png" alt="">
					</div>
					<div class="title-content__block title-content__text col-12 col-md-6 padding-bottom">
						<h1 class="border-bottom">О нас</h1>
						{$_modx->resource.localizator_content}
					</div>
				</div>

				<!-- Преимущества -->
				<div class="advantage-list padding-top padding-bottom margin-bottom">
					<div class="row">
						<div class="advantage-list__item col-12 col-md-4">
							<h4 class="border-bottom">100%</h4>
							<div class="advantage-list__description">
								<p>Индивидуальный подход</p>
							</div>
						</div>
						<div class="advantage-list__item col-12 col-md-4">
							<h4 class="border-bottom">10</h4>
							<div class="advantage-list__description">
								<p>Обучающих курсов</p>
							</div>
						</div>
						<div class="advantage-list__item col-12 col-md-4">
							<h4 class="border-bottom">200</h4>
							<div class="advantage-list__description">
								<p>Активных вакансии</p>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="main-content padding-top">
			<div class="container">
				...
				<div class="row padding-bottom">
					<div class="main-content__text col-12 col-lg-6">
						<h2>Наши цели</h2>
						<p>Наша команда преследует непростые, но в тоже время интересные задачи, в которых наши специалисты профессионалы.</p>
<ul>
<li>Обеспечить каждого клиента работодателя лучшими специалистами в сфере, подготовленными и протестированными под требование заказчика;</li>
<li>Подготовка специалиста к трудоустройству, а так же ведение специалиста с момента отправки, до возвращения домой;</li>
<li>Наши специалисты снабжения обеспечат лучшие конкурентоспособные предложения в отрасли по региону;</li>
...
<li>Новостной портал Apply Marine, будет держать вас в курсе последних известий морской и туристической отраслей.</li>
					...
					<div class="main-content__img col-12 col-lg-6">
						<img src="/upload/images/img-1.jpg" alt="Текстовый блок">
					</div>
				</div>

				<!-- Каталог срочных вакансий -->
				<div class="catalog job-catalog job-catalog-urgent padding-bottom padding-top">
					<h2 class="padding-bottom">urgentjob</h2>
					<div class="row">
					    ...
					    [[!pdoPage?
                            ...
                            &includeTVs=`tvAuthor,tvPrice,tvCurrency,tvAdditionalFee,tvContract`
                            &limit=`6`
                        ]]
			...
			<!-- Услуги -->
			<div class="catalog services services-title padding-bottom">
				<div class="container">
					<h2 class="padding-bottom">ourservices</h2>
					<div class="row">
					    ...
					    [[!pdoPage?
                            ...
                            &depth=`1`
                            &sortby=`{ "publishedon":"ASC"}`
                            &tpl=`tpl.catalog.service.item`
                            &includeTVs=`tvPrice,tvCurrency,tvServiceDescription`
                            &where=`{ "template:IN":[6,7]}`
                            &limit=`4`
                        ]]
					...
					<div class="services__all">
						<a href="uslugi.html" class="btn">seeallservices <i class="fas fa-caret-down"></i></a>
					</div>
			...
			<!-- Новостной блок -->
			<div class="news-list padding-top padding-bottom">
				<div class="container">
					<h2 class="paddin-bottom padding-bottom">ournews</h2>
					<div class="row">
					...
					<a href="novosti.html" class="btn news-list__all">seeallservices <i class="fas fa-caret-down"></i></a>
				</div>
			</div>
			<!-- Новостной блок -->
...
<div class="catalog__element col-12 col-md-6 col-lg-4">
	<div class="catalog__element__content">
		<div class="company"><a href="#"></a></div>
		<h4><a href="elektromexanik.html"></a></h4>
		<p></p>
		<div class="catalog__price">
			<div class="price">0 р. + Пай</div>
			<p>Контракт 1 месяца.</p>
			<a href="elektromexanik.html" class="btn">readmore</a>
		</div>
	</div>
</div>
<div class="catalog__element col-12 col-md-6 col-lg-4">
	<div class="catalog__element__content">
		<div class="company"><a href="#"></a></div>
		<h4><a href="matrosyi-2.html"></a></h4>
		<p></p>
		<div class="catalog__price">
			<div class="price">0 р. + Пай</div>
			<p>Контракт 1 месяца.</p>
			<a href="matrosyi-2.html" class="btn">readmore</a>
		</div>
	</div>
</div>
<div class="catalog__element col-12 col-md-6 col-lg-4">
	<div class="catalog__element__content">
		<div class="company"><a href="#"></a></div>
		<h4><a href="elektromexanik-2.html"></a></h4>
		<p></p>
		<div class="catalog__price">
			<div class="price">0 р. + Пай</div>
			<p>Контракт 1 месяца.</p>
			<a href="elektromexanik-2.html" class="btn">readmore</a>
		</div>
	</div>
</div>',
    '[[Localizator?snippet=`pdoResources`&class=`modResource`&localizator_key=``&plPrefix=``&limit=`4`&maxLimit=`100`&offset=`0`&page=`1`&pageVarKey=`page`&totalVar=`page.total`&pageLimit=`5`&element=`Localizator`&pageNavVar=`page.nav`&pageCountVar=`pageCount`&pageLinkScheme=``&tplPage=`@INLINE <li class="page-item"><a class="page-link" href="[[+href]]">[[+pageNo]]</a></li>`&tplPageWrapper=`@INLINE <ul class="pagination">[[+first]][[+prev]][[+pages]][[+next]][[+last]]</ul>`&tplPageActive=`@INLINE <li class="page-item active"><a class="page-link" href="[[+href]]">[[+pageNo]]</a></li>`&tplPageFirst=`@INLINE <li class="page-item"><a class="page-link" href="[[+href]]">[[%pdopage_first]]</a></li>`&tplPageLast=`@INLINE <li class="page-item"><a class="page-link" href="[[+href]]">[[%pdopage_last]]</a></li>`&tplPagePrev=`@INLINE <li class="page-item"><a class="page-link" href="[[+href]]">&laquo;</a></li>`&tplPageNext=`@INLINE <li class="page-item"><a class="page-link" href="[[+href]]">&raquo;</a></li>`&tplPageSkip=`@INLINE <li class="page-item disabled"><a class="page-link" href="#">...</a></li>`&tplPageFirstEmpty=`@INLINE <li class="page-item disabled"><a class="page-link" href="#">[[%pdopage_first]]</a></li>`&tplPageLastEmpty=`@INLINE <li class="page-item disabled"><a class="page-link" href="#">[[%pdopage_last]]</a></li>`&tplPagePrevEmpty=`@INLINE <li class="page-item disabled"><a class="page-link" href="#">&laquo;</a></li>`&tplPageNextEmpty=`@INLINE <li class="page-item disabled"><a class="page-link" href="#">&raquo;</a></li>`&cache=``&cacheTime=`3600`&cacheAnonymous=``&toPlaceholder=``&ajax=``&ajaxMode=``&ajaxElemWrapper=`#pdopage`&ajaxElemRows=`#pdopage .rows`&ajaxElemPagination=`#pdopage .pagination`&ajaxElemLink=`#pdopage .pagination a`&ajaxElemMore=`#pdopage .btn-more`&ajaxTplMore=`@INLINE <button class="btn btn-primary btn-more">[[%pdopage_more]]</button>`&ajaxHistory=``&setMeta=`1`&strictMode=`1`&parents=`9`&depth=`1`&sortby=`{ "publishedon":"ASC"}`&tpl=`tpl.catalog.service.item`&includeTVs=`tvPrice,tvCurrency,tvServiceDescription`&where=`{ "template:IN":[6,7]}`&request=`577738cfc10f5ceeee77c32bf10e27d0`&setTotal=`1`]]' => '<div class="catalog__element col-12 col-sm-6 col-md-4 col-xl-3">
	<div class="catalog__element__content ">
	    		<h4><a href="kursyi-anglijskogo-yazyika.html"></a></h4>
		<p></p>
		<div class="catalog__price">
			<div class="price">0 р. <small>  </small></div>
			<p></p>
			<a href="kursyi-anglijskogo-yazyika.html" class="btn">readmore</a>
		</div>
	</div>
</div>
<div class="catalog__element col-12 col-sm-6 col-md-4 col-xl-3">
	<div class="catalog__element__content ">
	    		<h4><a href="kursyi-ispanskogo-yazyika.html"></a></h4>
		<p></p>
		<div class="catalog__price">
			<div class="price">0 р. <small>  </small></div>
			<p></p>
			<a href="kursyi-ispanskogo-yazyika.html" class="btn">readmore</a>
		</div>
	</div>
</div>
<div class="catalog__element col-12 col-sm-6 col-md-4 col-xl-3">
	<div class="catalog__element__content ">
	    		<h4><a href="kursyi-russkogo-yazyika.html"></a></h4>
		<p></p>
		<div class="catalog__price">
			<div class="price">0 р. <small>  </small></div>
			<p></p>
			<a href="kursyi-russkogo-yazyika.html" class="btn">readmore</a>
		</div>
	</div>
</div>
<div class="catalog__element col-12 col-sm-6 col-md-4 col-xl-3">
	<div class="catalog__element__content ">
	    		<h4><a href="profilnyie-kursyi.html"></a></h4>
		<p></p>
		<div class="catalog__price">
			<div class="price">0 р. <small>  </small></div>
			<p></p>
			<a href="profilnyie-kursyi.html" class="btn">readmore</a>
		</div>
	</div>
</div>',
    '[[%further]]' => 'further',
    '[[Localizator?snippet=`pdoResources`&class=`modResource`&localizator_key=``&plPrefix=``&limit=`3`&maxLimit=`100`&offset=`0`&page=`1`&pageVarKey=`page`&totalVar=`page.total`&pageLimit=`5`&element=`Localizator`&pageNavVar=`page.nav`&pageCountVar=`pageCount`&pageLinkScheme=``&tplPage=`@INLINE <li class="page-item"><a class="page-link" href="[[+href]]">[[+pageNo]]</a></li>`&tplPageWrapper=`@INLINE <ul class="pagination">[[+first]][[+prev]][[+pages]][[+next]][[+last]]</ul>`&tplPageActive=`@INLINE <li class="page-item active"><a class="page-link" href="[[+href]]">[[+pageNo]]</a></li>`&tplPageFirst=`@INLINE <li class="page-item"><a class="page-link" href="[[+href]]">[[%pdopage_first]]</a></li>`&tplPageLast=`@INLINE <li class="page-item"><a class="page-link" href="[[+href]]">[[%pdopage_last]]</a></li>`&tplPagePrev=`@INLINE <li class="page-item"><a class="page-link" href="[[+href]]">&laquo;</a></li>`&tplPageNext=`@INLINE <li class="page-item"><a class="page-link" href="[[+href]]">&raquo;</a></li>`&tplPageSkip=`@INLINE <li class="page-item disabled"><a class="page-link" href="#">...</a></li>`&tplPageFirstEmpty=`@INLINE <li class="page-item disabled"><a class="page-link" href="#">[[%pdopage_first]]</a></li>`&tplPageLastEmpty=`@INLINE <li class="page-item disabled"><a class="page-link" href="#">[[%pdopage_last]]</a></li>`&tplPagePrevEmpty=`@INLINE <li class="page-item disabled"><a class="page-link" href="#">&laquo;</a></li>`&tplPageNextEmpty=`@INLINE <li class="page-item disabled"><a class="page-link" href="#">&raquo;</a></li>`&cache=``&cacheTime=`3600`&cacheAnonymous=``&toPlaceholder=``&ajax=``&ajaxMode=``&ajaxElemWrapper=`#pdopage`&ajaxElemRows=`#pdopage .rows`&ajaxElemPagination=`#pdopage .pagination`&ajaxElemLink=`#pdopage .pagination a`&ajaxElemMore=`#pdopage .btn-more`&ajaxTplMore=`@INLINE <button class="btn btn-primary btn-more">[[%pdopage_more]]</button>`&ajaxHistory=``&setMeta=`1`&strictMode=`1`&parents=`12`&tpl=`tpl.news.item`&includeTVs=`tvimage`&prepareTVs=`0`&sortby=`{ "publishedon":"DESC","longtitle":"ASC" }`&request=`b07d6a6c0e5c613470bd11db905e1ef8`&setTotal=`1`]]' => '<div class="news-list__item col-12">
	<div class="news-list__item-content">
		<div class="row">
			<div class="news-list__img col-12 col-sm-4 col-md-3 col-lg-2">
				<a href="pervoe-sudno-carnival-cruise-line-rabotayushhee-na-toplive-spg-2.html" class="item-img" title="">
                    <img src="/assets/cache_image/upload/images/news-2_200x200_d52.jpg" title="" al="">
                </a>
			</div>
			<div class="news-list__text col-12 col-sm-8 col-md-9 col-lg-10">
				...
				<div class="news-base-data news-element">
                    ...
                    <a href="pervoe-sudno-carnival-cruise-line-rabotayushhee-na-toplive-spg-2.html" class="btn gray-btn">further <i class="fas fa-arrow-right"></i></a>
	            </div>
    ...
    '[[Localizator?snippet=`pdoMenu`&class=`modResource`&localizator_key=``&plPrefix=``&limit=`10`&maxLimit=`100`&offset=`0`&page=`1`&pageVarKey=`page`&totalVar=`page.total`&pageLimit=`5`&element=`Localizator`&pageNavVar=`page.nav`&pageCountVar=`pageCount`&pageLinkScheme=``&tplPage=`@INLINE <li class="page-item"><a class="page-link" href="[[+href]]">[[+pageNo]]</a></li>`&tplPageWrapper=`@INLINE <ul class="pagination">[[+first]][[+prev]][[+pages]][[+next]][[+last]]</ul>`&tplPageActive=`@INLINE <li class="page-item active"><a class="page-link" href="[[+href]]">[[+pageNo]]</a></li>`&tplPageFirst=`@INLINE <li class="page-item"><a class="page-link" href="[[+href]]">[[%pdopage_first]]</a></li>`&tplPageLast=`@INLINE <li class="page-item"><a class="page-link" href="[[+href]]">[[%pdopage_last]]</a></li>`&tplPagePrev=`@INLINE <li class="page-item"><a class="page-link" href="[[+href]]">&laquo;</a></li>`&tplPageNext=`@INLINE <li class="page-item"><a class="page-link" href="[[+href]]">&raquo;</a></li>`&tplPageSkip=`@INLINE <li class="page-item disabled"><a class="page-link" href="#">...</a></li>`&tplPageFirstEmpty=`@INLINE <li class="page-item disabled"><a class="page-link" href="#">[[%pdopage_first]]</a></li>`&tplPageLastEmpty=`@INLINE <li class="page-item disabled"><a class="page-link" href="#">[[%pdopage_last]]</a></li>`&tplPagePrevEmpty=`@INLINE <li class="page-item disabled"><a class="page-link" href="#">&laquo;</a></li>`&tplPageNextEmpty=`@INLINE <li class="page-item disabled"><a class="page-link" href="#">&raquo;</a></li>`&cache=``&cacheTime=`3600`&cacheAnonymous=``&toPlaceholder=``&ajax=``&ajaxMode=``&ajaxElemWrapper=`#pdopage`&ajaxElemRows=`#pdopage .rows`&ajaxElemPagination=`#pdopage .pagination`&ajaxElemLink=`#pdopage .pagination a`&ajaxElemMore=`#pdopage .btn-more`&ajaxTplMore=`@INLINE <button class="btn btn-primary btn-more">[[%pdopage_more]]</button>`&ajaxHistory=``&setMeta=`1`&strictMode=`1`&parents=`0`&resources=`-17`&level=`1`&tpl=`@INLINE <li><a href="[[+link]]">[[+menutitle]]</a></li>`&tplOuter=`@INLINE <ul>[[+wrapper]]</ul>`&request=`2c7ce81946818faf9e7ffab92fa3e158`&setTotal=`1`]]' => '<ul><li><a href="moyo-rezyume1.html"></a></li><li><a href="registracziya-kompanii.html"></a></li></ul>',
  ),
  'sourceCache' => 
  array (
    'modChunk' => 
		...
		return $output;
          ...
          array (
            ...
            array (
              ...
              'area' => '',
              'desc_trans' => 'Номера рекламных позиций для вывода баннеров, через запятую.',
              'area_trans' => '',
            ),
            'showLog' => 
            array (
            ...
            array (
              ...
              'lexicon' => 'bannery:properties',
              'area' => '',
              'desc_trans' => 'Ограничение выборки.',
              'area_trans' => '',
            ),
            'offset' => 
            array (
            ...
            array (
              ...
              'lexicon' => 'bannery:properties',
              'area' => '',
              'desc_trans' => 'Поле для сортировки выборки, можно указывать "RAND()".',
              'area_trans' => '',
            ),
            'sortdir' => 
            array (
...
',
            ...
            array (
              ...
              'lexicon' => 'bannery:properties',
              'area' => '',
              'desc_trans' => 'Показывать отключенные позиции.',
              'area_trans' => '',
            ),
            'tpl' => 
            array (
              ...
              'lexicon' => 'bannery:properties',
              'area' => '',
              'desc_trans' => 'Имя чанка для оформления баннера. Если не указан, то содержимое полей баннера будет распечатано на экран.',
              'area_trans' => '',
            ),
            'tplFirst' => 
            array (
              ...
              'lexicon' => 'bannery:properties',
              'area' => '',
              'desc_trans' => 'Имя чанка для первого баннера в результатах.',
              'area_trans' => '',
            ),
            'tplLast' => 
            array (
              ...
              'lexicon' => 'bannery:properties',
              'area' => '',
              'desc_trans' => 'Имя чанка для последнего баннера в результатах.',
              'area_trans' => '',
            ),
            'tplOdd' => 
            array (
              ...
              'lexicon' => 'bannery:properties',
              'area' => '',
              'desc_trans' => 'Имя чанка для каждого второго баннера.',
              'area_trans' => '',
            ),
            'tplWrapper' => 
            array (
...
return $flag ? $modx->phpThumbOn->run($scriptProperties) : $modx->getOption(\'phpthumbon.noimage\', $scriptProperties);',
      ...
      array (
        ...
        array (
          ...
          'property_preprocess' => false,
          'name' => 'numformat',
          'description' => 'Разбиение числа по разрядам',
          'editor_type' => 0,
          'category' => 43,
          'cache_type' => 0,
          'snippet' => 'if(strlen($input) == 0) return;
...
return number_format($input,(floor($input) == $input ? 0 : 2),\'.\',\' \');',
          ...
          'static' => false,
          'static_file' => '',
          'content' => 'if(strlen($input) == 0) return;
$input = floatval(str_replace(array(\' \',\',\'), array(\'\',\'.\'), $input));
return number_format($input,(floor($input) == $input ? 0 : 2),\'.\',\' \');',
        ),
        'policies' => 
    ...
    array (
      ...
      array (
        ...
        array (
          ...
          'description' => 'Укажите здесь заголовок страницы, который будет выведен в дальнейшем в поисковых системах после индексации',
          'editor_type' => 0,
          'category' => 24,
          'locked' => false,
          'elements' => '',
      ...
      array (
        ...
        array (
          ...
          'caption' => 'Описание страницы (meta-description)',
          'description' => 'Укажите здесь описание страницы с контентом, которое будет выводится в поисковых системах',
          'editor_type' => 0,
          'category' => 24,
          'locked' => false,
          'elements' => '',
      ...
      array (
        ...
        array (
          ...
          'type' => 'text',
          'name' => 'meta-keywords',
          'caption' => 'Ключевики (meta-keywords)',
          'description' => 'Укажите здесь ключевые слова или словосочетания, не более трёх штук',
          'editor_type' => 0,
          'category' => 24,
          'locked' => false,
          'elements' => '',
      ...
      array (
        ...
        array (
          ...
          'type' => 'listbox',
          'name' => 'meta-noindex',
          'caption' => 'Индексация страницы',
          'description' => 'Установите "Отключена", если вам необходимо что бы данная страница не индексировалась',
          'editor_type' => 0,
          'category' => 24,
          'locked' => false,
          'elements' => 'Включена==<meta name="robots" content="all"/>||Отключена==<meta name="robots" content="noindex"/>',
          'rank' => 0,
          'display' => 'default',
          'default_text' => '<meta name="robots" content="all"/>',
          'properties' => 
          array (
          ),
          'input_properties' => 
      ...
      array (
        ...
        array (
          ...
          'type' => 'listbox',
          'name' => 'nocopy',
          'caption' => 'Защита от копирования',
          'description' => 'Укажите необходимое значение, оно влияет на то будет ли возможно копирование с данной страницы',
          'editor_type' => 0,
          'category' => 24,
          'locked' => false,
          'elements' => 'Включена== oncopy="return false"||Отключена== oncopy="return true"',
          'rank' => 0,
          'display' => 'default',
          'default_text' => ' oncopy="return false"',
          'properties' => 
          array (
          ),
          'input_properties' => 
      ...
      array (
        ...
        array (
          ...
          'property_preprocess' => false,
          'type' => 'text',
          'name' => 'tvAddContentTitle',
          'caption' => 'Заголовок для дополнительного контента на странице',
          'description' => 'Добавьте сюда текст для вывода на странице',
          'editor_type' => 0,
          'category' => 26,
          'locked' => false,
          'elements' => '',
      ...
      array (
        ...
        array (
          ...
          'type' => 'richtext',
          'name' => 'tvAddContent',
          'caption' => 'Дополнительный контент на странице',
          'description' => 'Добавьте сюда текст для вывода на странице',
          'editor_type' => 0,
          'category' => 26,
          'locked' => false,
      ...
      array (
        ...
        array (
          ...
          'type' => 'image',
          'name' => 'tvMarkMap',
          'caption' => 'Своя метка на карте яндекс',
          'description' => 'Укажите здесь путь до картинки (формат PNG), она должна быть квадратной. Что бы она нормально выглядела, необходимо что бы картинка была не меньше чем 42х42 px',
          'editor_type' => 0,
          'category' => 29,
          'locked' => false,
          'elements' => '',
      ...
      array (
        ...
        array (
          ...
          'type' => 'yandexcoordstv',
          'name' => 'tvCoordinats',
          'caption' => 'Координаты на Яндекс.Карте',
          'description' => 'Данные координаты работают вместе с чанком [[$MAP]] - выводит Яндекс.Карту на сайт. Если вдруг поиск по карте не осуществляется, впишите координаты в поле ниже, без скобок',
          'editor_type' => 0,
          'category' => 29,
          'locked' => false,
          'elements' => '',
