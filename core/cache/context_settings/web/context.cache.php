<?php  return array (
  'config' => 
  array (
    'office_auth_page_id' => '1',
    'office_profile_page_id' => '40',
  ),
  'aliasMap' => 
  array (
    '.html' => 1,
    ...
    'rezyume.html' => 56,
    'uslugi.html' => 9,
    'uslugi-dlya-kompanii.html' => 58,
    'turyi.html' => 31,
    'konferenczii.html' => 34,
    'novosti.html' => 12,
    'kontaktyi.html' => 17,
    'lichnyij-kabinet.html' => 39,
    'oformlenie-zakaza.html' => 43,
    'moyo-rezyume1.html' => 53,
    'registracziya-kompanii.html' => 55,
    'poisk.html' => 7,
    'system-asdasd.html' => 2,
    'upgrade-modx.html' => 54,
    'snyatyie-s-publikaczii-punktyi-ne-udalyat.html' => 90,
    'stranicza-ne-sushhestvuet-oshibka-404.html' => 3,
    'sajt-ne-dostupen-oshibka-503.html' => 4,
    'dostup-zakryit-oshibka-403.html' => 5,
    'karta-sajta.html' => 6,
    'usloviya-peredachi-informaczii.html' => 8,
    'additional.css' => 15,
    'test.html' => 16,
    'avtorizacziya.html' => 42,
    'kursyi.html' => 33,
    'testirovanie.html' => 28,
    'soprovozhdeniya.html' => 35,
    'vizyi-sc.html' => 29,
    'biletyi.html' => 30,
    'dokumentyi.html' => 32,
    'xoroshaya-novost-dlya-sudovyix-mexanikov-i-elektromexanikov.html' => 13,
    'pervoe-sudno-carnival-cruise-line-rabotayushhee-na-toplive-spg-2.html' => 14,
    'mexanik.html' => 10,
    'pomoshhnik-kapitana.html' => 11,
    'matrosyi.html' => 19,
    'elektromexanik.html' => 20,
    'matrosyi-2.html' => 21,
    'elektromexanik-2.html' => 22,
    'ces.html' => 44,
    'marlins.html' => 45,
    'profilnoe.html' => 46,
    'vizyi.html' => 24,
    'vizyi-2.html' => 26,
    'podbor-turov.html' => 50,
    'onlajn-konsultacziya.html' => 51,
    'goryashhie-turyi.html' => 52,
    'kursyi-anglijskogo-yazyika.html' => 25,
    'kursyi-ispanskogo-yazyika.html' => 47,
    'kursyi-russkogo-yazyika.html' => 48,
    'profilnyie-kursyi.html' => 49,
    'agentskie-uslugi.html' => 27,
    'profil.html' => 40,
    'istoriya-zakazov.html' => 41,
    'menedzhment.html' => 36,
    'agentstkie-uslugi.html' => 38,
    'snabzhenie.html' => 37,
    'podbor-personala.html' => 18,
    'kopiya-mexanik.html' => 60,
    'kopiya-pomoshhnik-kapitana.html' => 61,
    'kopiya-matrosyi.html' => 62,
    'kopiya-elektromexanik.html' => 63,
    'kopiya-ces.html' => 67,
    'kopiya-marlins.html' => 68,
    'kopiya-profilnoe.html' => 69,
    'kopiya-vizyi.html' => 71,
    'kopiya-podbor-turov.html' => 75,
    'kopiya-onlajn-konsultacziya.html' => 76,
    'kopiya-goryashhie-turyi.html' => 77,
    'kopiya-kursyi-anglijskogo-yazyika.html' => 80,
    'kopiya-kursyi-ispanskogo-yazyika.html' => 81,
    'kopiya-kursyi-russkogo-yazyika.html' => 82,
    'kopiya-profilnyie-kursyi.html' => 83,
    'kopiya-agentskie-uslugi.html' => 89,
    'kopiya-podbor-personala.html' => 59,
    'kopiya-testirovanie.html' => 66,
    'kopiya-biletyi.html' => 73,
    'kopiya-turyi.html' => 74,
    'kopiya-dokumentyi.html' => 78,
    'kopiya-kursyi.html' => 79,
    'kopiya-konferenczii.html' => 84,
    'kopiya-soprovozhdeniya-v-trudoustrojstve.html' => 85,
    'kopiya-menedzhment.html' => 86,
    'kopiya-agentstkie-uslugi.html' => 88,
    'kopiya-snabzhenie.html' => 87,
  ),
  'resourceMap' => 
  array (
    0 => 
...
switch ($e->name) {
  ...
  //print_r(\'1\'.$o.\'2\');
        ...
        for($n=0;$n<count($imgs[0]);$n++) {
            ...
            $path_img = preg_replace("/^.+src=(\'|\\")/ui","",$imgs[0][$n]);                                            
            $path_img = preg_replace("/(\'|\\").*$/ui","",$path_img);                                                                           
            //-----------------------
            if (substr($path_img,0,strlen($path_base)) == $path_base) {                                                                     
                ...
                if ($verif_balise > 0) {
                    ...
                    $heigth = preg_replace("/[^0123456789]/","",$array[0]);
                    //-------------------
                    preg_match("/width *(:|=) *[\\"\']* *\\d+ *[\\"\']*/",$img,$array);
                    $width = preg_replace("/[^0123456789]/","",$array[0]);
                    //-------------------
                    if ($style) {
                        $imgf = preg_replace("/(height|HEIGHT|Height) *: *[0123456789]* *(px)* */ui","",$imgs[0][$n]);
                        $imgf = preg_replace("/(width|WIDTH|Width) *: *[0123456789]* *(px)* */ui","",$imgf);
                    } else {
                        $imgf = preg_replace("/(height|HEIGHT|Height) *= *[\\"\']* *[0123456789]* *(px)* *[\\"\']*/ui","",$imgs[0][$n]);
                        $imgf = preg_replace("/(width|WIDTH|Width) *= *[\\"\']* *[0123456789]* *(px)* *[\\"\']*/ui","",$imgf);
                    }
        ...
        $head = \'<script src="assets/components/directresize/js/highslide.packed.js"></script><script>
...
if (is_array($resizeConfigs) && count($resizeConfigs) > 0) {
    ...
    array (
      ...
      'category' => '0',
      'cache_type' => '0',
      'plugincode' => '$output = $modx->resource->_output;
...
switch ($modx->event->name) {
    case \'OnHandleRequest\':
      ...
      'moduleguid' => '',
      'static' => '0',
      'static_file' => 'core/components/logrotation/elements/plugins/logrotation.php',
    ),
    28 => 
    array (
      'id' => '28',
...
elseif (isset($result)) {
    ...
    case \'OnWebPagePrerender\':
      ...
      'moduleguid' => '',
      'static' => '0',
      'static_file' => 'core/components/modlastmodified/elements/plugins/plugin.modlastmodified.php',
    ),
    30 => 
    array (
      'id' => '30',
    ...
    case \'OnHandleRequest\':
        if (!empty($_GET[\'action\']) && $_GET[\'action\'] == \'office/login_as\') {
            ...
            if (!empty($authorized[\'mgr\']) && $modx->context->key != \'mgr\') {
                /** @var modUser $mgr_user */
                $mgr_user = $modx->getObject(\'modUser\', $authorized[\'mgr\']);
                if ($modx->context->checkPolicy(\'office_login_as\', null, $mgr_user)) {
                    /** @var modUser $user */
    ...
    case \'OnManagerPageBeforeRender\':
        ...
        switch ($controller->config[\'controller\']) {
            ...
            case \'security/user/update\':
                if ($modx->hasPermission(\'office_login_as\')) {
                    $controller->addLexiconTopic(\'office:default\');
...
$PayAndSee->processEvent($modx->event, $scriptProperties);',
      ...
      'moduleguid' => '',
      'static' => '0',
      'static_file' => 'core/components/payandsee/elements/plugins/plugin.system.php',
    ),
    39 => 
    array (
      'id' => '39',
...
$modx->map[\'msOrderProduct\'][\'aggregates\'][\'Content\'] = array(
    ...
    \'owner\'       => \'local\',
      ...
      'moduleguid' => '',
      'static' => '0',
      'static_file' => 'core/components/payandsee/elements/plugins/plugin.init.php',
    ),
    40 => 
    array (
      'id' => '40',
...
switch($modx->event->name) {
    ...
    case \'pdoToolsOnFenomInit\':
      ...
      'moduleguid' => '',
      'static' => '0',
      'static_file' => 'core/components/localizator/elements/plugins/plugin.localizator.php',
    ),
    41 => 
    array (
      'id' => '41',
