    ...
    array (
      ...
      array (
        ...
        array (
          ...
          'policy' => 
          array (
            'payandsee_alert_edit' => true,
            'payandsee_alert_view' => true,
            'payandsee_client_edit' => true,
            'payandsee_client_view' => true,
            'payandsee_content_edit' => true,
            'payandsee_content_view' => true,
            'payandsee_rate_edit' => true,
            'payandsee_rate_view' => true,
            'payandsee_status_edit' => true,
            'payandsee_status_view' => true,
            'payandsee_subscription_edit' => true,
            'payandsee_subscription_view' => true,
            'payandsee_setting_edit' => true,
            'payandsee_setting_view' => true,
          ),
        ),
        3 => 
        array (
          ...
          array (
            ...
            'localizatorcontent_view_ru' => true,
            'localizatorcontent_save_ru' => true,
            'localizatorcontent_view_en' => true,
            'localizatorcontent_save_en' => true,
            'localizatorcontent_view_es' => true,
            'localizatorcontent_save_es' => true,
          ),
        ),
      ),
    ),
